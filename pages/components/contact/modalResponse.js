        ...
        <div className=" w-full h-full absolute">
          <div className="fixed inset-0 z-20 overflow-y-auto">
            <div className="flex flex-col justify-center items-center min-h-screen">
              <div className=" xl:w-[30vw] lg:w-[40vw] md:w-[55vw] sm:w-[500px] w-[90vw] h-[320px] relative  mx-auto bg-white rounded-xl shadow-2xl shadow-black">
                <div className=" sm:flex flex flex-col justify-center items-center pt-2 px-2 ">
                  ...
                  {!dataLoaded ? (
                    ...
                    <div className=" text-center sm:ml-4 sm:text-left px-5 flex flex-col justify-center items-center">
                      <img
                        src={icon}
                        className=" xl:w-32 lg:w-32 md:w-24 sm:w-24 w-24  "
                      ></img>
                      <h1 className=" text-5xl leading-relaxed text-[#061994] font-bold ">
                        {title}
                      </h1>
                      <p className=" whitespace-nowrap text-[#061994] text-xl">
                        {text}
                      </p>
                    </div>
                  )}
